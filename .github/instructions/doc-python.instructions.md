...
- **Comentários explicativos:** Se a função ou classe não tiver comentários, adicione comentários de linha explicando o propósito e lógica do código.
...
- **Evite Any do Typing:** Não utilize o tipo `Any` diretamente do módulo `typing`. Caso seja necessário, crie um alias: `type AnyType = Any`.
